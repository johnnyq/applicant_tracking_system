...
if($session_agree_terms == 0){
  mysqli_query($mysqli,"UPDATE candidates SET current_status = 'Applying - Form w4' WHERE candidate_id = $session_candidate_id");
}
?>
    ...
    <form class="border p-3" action="post_kiosk.php" method="post" autocomplete="off">
      ...
      <div class="form-group">
        ...
        <div class="form-check">
          <input class="form-check-input" type="radio" name="box3" value="Single">
          <label class="form-check-label">
            Single
          </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="box3" value="Married">
          <label class="form-check-label">
            Married
          </label>
        </div>
        <div class="form-check">
          <input class="form-check-input" type="radio" name="box3" value="Married, but withhold at higher Signle rate">
          <label class="form-check-label">
      ...
      <div class="form-group">
        ...
        <div class="form-group form-check">
           ...
           <label class="form-check-label">
              <small>I claim exemption from withholding for <?php echo date('Y'); ?>, and I certify that I meet both of the following conditions for exemption.
                <ul>
      ...
      <br><br>
      <button type="submit" name="add_w4" class="btn btn-success btn-block btn-lg mb-3"><i class="fa fa-check"></i> Save</button>
    </form>
  </div>
  <div class="col-md-7">
...
<div class="row">
  <div class="col-md-12">
    <div class="border p-3 mt-5">
      <a href="kiosk_candidate_references.php"><i class="fa fa-arrow-left"></i> Back - References</a>
      <a href="kiosk_candidate_i9.php" class="float-right">Next - I-9 Form <i class="fa fa-arrow-right"></i></a>
    </div>
  </div>
</div>
<!-- Modal -->
